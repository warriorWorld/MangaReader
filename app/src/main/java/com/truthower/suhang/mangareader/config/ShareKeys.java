...
public class ShareKeys {
    ...
    public static final String CLOSE_WRAP_IMG = "close_wrap_img";
    ...
    public static final String CLOSE_WORD_IMG = "close_word_img";
    public static final String CLOSE_CLICK_IMG = "close_click_img";
    ...
    public static final String DOWNLOAD_FOLDER_SIZE = "download_folder_size";
