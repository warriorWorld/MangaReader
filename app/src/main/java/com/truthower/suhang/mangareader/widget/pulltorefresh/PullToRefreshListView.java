...
//	private LoadingLayout mRefreshHeaderLayout;
    ...
    public void setScrollLoadEnabled(boolean scrollLoadEnabled) {
        ...
        if (scrollLoadEnabled) {
            // 设置Footer
            if (null == mLoadMoreFooterLayout) {
                mLoadMoreFooterLayout = new SilupayFooterLayout(getContext());
...
//	public void setFooterLoadingLayout(LoadingLayout footer) {
//		this.mLoadMoreFooterLayout = footer;
//	}

    // public void setHeaderLoadingLayout(LoadingLayout header) {
    // this.mRefreshHeaderLayout = header;
    // }
    ...
    protected LoadingLayout createHeaderLoadingLayout(Context context, AttributeSet attrs) {
        ...
        // else
        // return mRefreshHeaderLayout;
        return new SilupayLoadingLayout(context);
    }

    @Override
    protected LoadingLayout createFooterLoadingLayout(Context context, AttributeSet attrs) {
        return new SilupayFooterLayout(context);
    }
